...
import { UserPlus, Mail, Lock, User, ArrowRight, Loader, Home, Users } from "lucide-react";
								...
								>
									<div className='flex items-center justify-center flex-col'>
										<Users className={`h-8 w-8 mb-2 ${
											formData.role === 'user' ? 'text-emerald-400' : 'text-gray-400'
										}`} />
										<span className={`text-sm font-medium ${
											formData.role === 'user' ? 'text-emerald-400' : 'text-gray-300'
										}`}>
											User
										</span>
								...
								>
									<div className='flex items-center justify-center flex-col'>
										<Home className={`h-8 w-8 mb-2 ${
											formData.role === 'host' ? 'text-emerald-400' : 'text-gray-400'
										}`} />
										<span className={`text-sm font-medium ${
											formData.role === 'host' ? 'text-emerald-400' : 'text-gray-300'
										}`}>
											Host
										</span>
										<span className='text-xs text-gray-400 mt-1 text-center'>
						...
						>
							{loading ? (
								...
								<>
									...
									Sign up as {formData.role === 'host' ? 'Host' : 'User'}
								</>
							)}
						</button>
					</form>
